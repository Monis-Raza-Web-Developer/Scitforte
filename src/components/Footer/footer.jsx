...
const Footer = () => {
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 items-start">
        ...
        <div className="flex flex-col items-start">
          <img
            ...
            className="w-50"
          />
          <p className="text-black text-sm leading-relaxed mt-10">
      ...
      {/* Bottom Line */}
      <div className="border-t border-gray-700 mt-10 pt-5 text-center text-sm text-black">
        © {new Date().getFullYear()} ScitForte. All rights reserved.
      </div>
    </footer>
    </>
  )
